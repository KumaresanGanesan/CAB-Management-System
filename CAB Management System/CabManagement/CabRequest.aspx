<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CabRequest.aspx.cs" Inherits="CAB_Management_System.Cab_Management.CabRequest" %>
                            ...
                            <%--         <asp:TemplateField HeaderText="Trip Type">
                                <ItemTemplate>
                                    <asp:DropDownList ID="ddlTripType" runat="server">
                                        ...
                                        <asp:ListItem Text="Return" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="One Way" Value="1"></asp:ListItem>
                                    </asp:DropDownList>
                                </ItemTemplate>
                            </asp:TemplateField>--%>
